      ...
      >
        <TooltipProvider>
          ...
          <header className="text-center py-10 md:py-16 px-4">
            <p className="text-muted-foreground text-xs md:text-sm uppercase tracking-[3px] font-serif italic mb-3 md:mb-4">
              Observatorio Congreso
            </p>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-wide font-serif text-white drop-shadow-lg">
              JOSE ANTONIO KAST
            </h1>
            <div className="flex justify-center gap-3 mt-3 md:mt-4">
              <span className="bg-white/10 px-3 md:px-4 py-1.5 rounded-full text-[10px] md:text-xs tracking-wider border border-white/20">
                DIPUTADO 2002-2018
              </span>
            </div>
          </header>
          ...
          <footer className="border-t border-white/5 mt-20 bg-[#0F0F0F]">
            <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-10 px-6 md:px-8 py-10 md:py-14">
              {/* Columna 1: Conecta */}
              <div className="min-w-[240px] sm:min-w-[280px] flex-1">
              ...
              <div className="min-w-[200px]">
                ...
                <div className="flex flex-col gap-3">
                  {[
                    { label: "Notas", href: "https://observatoriocongreso.cl/notas/" },
                    { label: "Sobre Nosotros", href: "#" },
                    { label: "Metodología de Datos", href: "#" },
