# Revisión de Datos de Observatorio Congreso

Este documento contiene los valores únicos extraídos de la base de datos para facilitar la identificación de errores de formato, nombres duplicados o inconsistencias.

## 1. Diputados (dim_diputados)

### 1.1 Nombres de Diputados (`diputado`)
Total únicos: 704
...
- `Pedro Guzmán Alvarez`
- `Pedro Muñoz Aburto`
- `Pedro Muñoz Aburto `
- `Pedro Pablo Alvarez-Salamanca Buchi`
- `Pedro Pablo Álvarez-Salamanca Buchi`
- `Pedro Pablo Alvarez-Salamanca Buchi `
...
- `Ramon Enrique Jaramillo Becker`
- `Ramón Farias Ponce`
- `Ramón Farías Ponce`
- `Ramón Galleguillos Castillo`
- `Ramon Jose Barros Montero `
- `Ramon Perez Opazo `
- `Raúl Leiva Carvajal`
- `Raúl Saldivar Auger`
- `Raúl Saldívar Auger`
- `Raúl Soto Mardones`
- `Raúl Sunico Galdames`
- `Raúl Urrutia Avila`
- `Raul Urrutia Avila `
- `Renan Fuentealba Vildosola`
...
- `Ricardo Rincón Gonzalez`
- `Ricardo Rincón González`
- `Rio Eduardo Diaz Del Rio`
...
### 1.2 Partidos Políticos (`partido_politico`)
Total únicos: 50
...
- `Independiente (Ciudadanos)`
- `Independiente (Comunes)`
- `Independiente (CS)`
- `Independiente (DC)`
- `Independiente (Evopoli)`
- `Independiente (ILA)`
- `Independiente (ILB)`
- `Independiente (ILC)`
- `Independiente (ILD)`
...
- `Partido Acción Regionalista de Chile`
- `Partido Comunista`
- `Partido de la Gente`
- `Partido Del Sur`
...
### 1.5 Bancadas y Comités (`bancada_comite`)
Total únicos: 48

- `Cominista `
- `Comité Comunista, Federación Regionalista Verde Social, Acción Humanista e Independientes`
- `Comité Comunista, Federación Regionalista Verde Social, Acción Humanista e Independientes `
- `Comité Evolución Política `
- `Comité Frente Amplio RD, Comunes y Convergencia Social`
- `Comité Frente Amplio RD, Comunes y Convergencia Social `
- `Comité Independientes`
- `Comité Independientes `
- `Comité Mixto de los Partidos Liberal, Socialista e Independientes`
- `Comité Mixto Humanista - Federación Regionalista Verde Social - Ecologista Verde - Independientes`
- `Comité Mixto Radical - Liberal - DC - Amarillos`
- `Comité Mixto Radical - Liberal - DC - Amarillos `
- `Comité Mixto RD, Comunes, Convergencia Social e Independientes`
- `Comité Partido de la Gente e Independientes`
- `Comité Partido de la Gente e Independientes `
- `Comité Partido Por la Democracia `
- `Comité Partido Socialista`
- `Comité Renovación Nacional`
- `Comité Renovación Nacional `
- `Comité Republicanos`
- `Comité Social Cristiano e Independientes`
- `Comité Social Cristiano e Independientes `
- `Comité Unión Demócrata Independiente`
- `Comunista`
- `Demócrata Cristiano`
- `Evolución Politica`
- `Independientes sin comité`
- `No informa`
- `Partdo Socialista`
- `Partido Comunista`
...
### 2.1 Estado del Proyecto (`estado_del_proyecto_de_ley`)
Total únicos: 5
...
- `Discusión general`
- `Oficio aprobación de modificaciones a Cámara Revisora`
- `Primer Informe`
- `Sin información`

### 2.3 Tipo de Proyecto (`tipo_de_proyecto`)
Total únicos: 3
...
### 2.4 Cámara de Origen (`camara_de_origen`)
Total únicos: 1

- `C.Diputados`

### 2.5 Temáticas Principales (`tematica`)
Total únicos: 22
